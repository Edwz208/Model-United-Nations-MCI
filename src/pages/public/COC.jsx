function COC() {
  ...
  return (
    ...
    <div className="w-[60%] flex flex-col gap-y-4 pt-16 items-center mx-auto text-text-gray text-all-children">
      ...
      <h2>18. Shelving of a Resolution</h2>
      ...
      <h2>25. Limitation of Motions</h2>
      ...
      <h2>29. Point of Personal Privilege</h2>
      ...
      <h2>38. Conduct During Voting</h2>
      ...
      <h2>40. Clause by Clause Vote</h2>
