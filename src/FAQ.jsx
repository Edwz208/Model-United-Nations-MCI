function FAQ(){
    return(
      <div style={{fontFamily: 'jetbrains mono', width: '40%', padding: '50px', color: 'white', margin: 'auto'}}>
        ...
        <h3>What is roll call?</h3>
        <p>Roll call at its most basic simply means that the Chair conducts attendance to make sure that all delegations are present. However, during the roll call in the mornings of both days, delegations are permitted to perform a short skit or present a short video no longer than one minute on a topic relating to their nation or its foreign policies.</p>
        ...
        <h3>How does the Agenda work?</h3>
        ...
        <h3>What are the committees in MMUN? How do they work?</h3>
        ...
        <h3>What should I wear to the MMUN?</h3>
        <p>Formal dress is required. Most delegates wear standard business attire (suits and ties for men; pantsuits or skirts for women). However, delegates may dress in the traditional clothing of the nation they represent. No country has jeans or running shoes as its traditional garb.</p>

        <h3>Are there awards at MMUN? What do I need to do to win an award?</h3>
        ...
        <h3>What is the page system? How do I use it?</h3>
        <p>The page system is a communication body comprised of message-runners who assist in the smooth operation of the conference. On the notepaper provided, delegates may write memos to the Chair or another delegation and have it delivered by a page. The page system is especially important in enabling delegates to add their delegations to the speaker's list and to question other countries on resolution-related matters. The page system is available in both the GA and the committees but is suspended during voting. The Chair may suspend the page system at its discretion. A note to be delivered must include its sender's name and its destination, legibly written. It is the pages' prerogative to look at the contents of notes and divert them to the Chair if they are inappropriate.</p>

        <h3>What are expectations with regards to behaviour at MMUN?</h3>
